...
*  Minor in **Game Design and Development** at Bezalel Academy | Specializing in **Unity** + **C#**
*  Currently working on my final game project in Bezalel.

## Skills & Tech Stack
* **Languages**: C#, Python, C, C++, java
* **Game Engines**: Unity, Godot
* **Tools**: Git, Unity
* **Other**: Algorithms, Data Structures, Object-Oriented Programming (OOP), Design Patterns, Project management
...
> Role: Gameplay Programmer - implemented enemy AI logic and behaviors, core scoring systems, and state-driven animator logic.
