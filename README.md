...
* Currently building **Codename 'Zinnia'**, my final game project for the Bezalel minor

## Skills & Tech Stack
* **Languages**: C#, Python, C, C++, Java
* **Game Engines**: Unity (6 / URP), Godot
* **Tools**: Git, Unity, Rider / Visual Studio, Claude Code, MCP
* **Concepts**: Data Structures & Algorithms, OOP, Design Patterns, Procedural Generation, Computer Vision
...
A single-button boss battle built for the Advanced Unity course - a study in clean, scalable and modular architecture.
...
> **Role**: Gameplay Programmer - architected the enemy system with the Strategy pattern: swappable movement and targeting behaviours, an interface-based health/damage system and a data-driven multi-spawn-point spawner with escalating difficulty.
...
> **Core mechanics**: Randomly generated house layouts, progression-based upgrade systems, and room-specific enemy variants.
